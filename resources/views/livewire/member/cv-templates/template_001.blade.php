<!-- Template: Premium ATS (Purple) -->
<div style="background: #ffffff; min-height: 297mm; color: #000000; font-family: Arial, Helvetica, sans-serif;">
    <!-- Header Section -->
    <table cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; background-color: #2E004B; color: #ffffff;">
        <tr>
            <td style="padding: 10mm 15mm;">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        <!-- Left Info -->
                        <td style="vertical-align: middle; padding-right: 20px;">
                            <h1 style="font-size: 32px; font-weight: bold; margin: 0 0 10px 0; line-height: 1.2; color: #ffffff !important; text-transform: uppercase;">{{ $data['full_name'] ?: ($labels['placeholder_name'] ?? 'Your Name') }}</h1>
                        ...
                        <td style="width: 130px; vertical-align: middle;">
                            <div style="width: 120px; height: 120px; background-color: #ffffff; overflow: hidden; border: 3px solid #ffffff;">
    ...
    <div style="padding: 10mm 15mm;">
        ...
        <div style="margin-bottom: 30px;">
            <div style="background-color: #2E004B; color: #ffffff; padding: 6px 12px; font-weight: bold; text-transform: uppercase; font-size: 14px; margin-bottom: 12px; display: block;">
        ...
        <div style="margin-bottom: 30px;">
            <div style="background-color: #2E004B; color: #ffffff; padding: 6px 12px; font-weight: bold; text-transform: uppercase; font-size: 14px; margin-bottom: 15px; display: block;">
                    ...
                    <td style="padding-bottom: 20px;">
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: bold; font-size: 12px; color: #2E004B;">{{ $exp['period'] }}</td>
                            </tr>
                            <tr>
                    ...
                    <td style="padding-bottom: 15px;">
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: bold; font-size: 12px; color: #2E004B;">{{ $edu['period'] }}</td>
                            </tr>
                            <tr>
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <div style="margin-bottom: 12px;">
                            <div style="font-weight: bold; font-size: 12px;">{{ $proj['name'] }}</div>
                             <div style="font-size: 11px; text-decoration: underline; color: #2E004B;">{{ $proj['link'] }}</div>
