...
<div style="background: #ffffff; min-height: 297mm; color: #000000; font-family: Arial, Helvetica, sans-serif;">
    <!-- Header Section -->
    <table cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; background-color: #7C3AED; color: #ffffff;">
        <tr>
            <td style="padding: 10mm 15mm; vertical-align: middle;">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 130px; padding-right: 30px; vertical-align: middle;">
                            <div style="width: 120px; height: 120px; border-radius: 50%; border: 4px solid rgba(255,255,255,0.3); background-color: #ffffff; overflow: hidden; margin: 0 auto;">
    ...
    <div style="padding: 10mm 15mm;">
        ...
        <div style="margin-bottom: 30px;">
            <div style="color: #7C3AED; font-weight: bold; text-transform: uppercase; font-size: 14px; margin-bottom: 12px; padding-bottom: 6px; border-bottom: 2px solid #7C3AED; display: block;">
        ...
        <div style="margin-bottom: 30px;">
            <div style="color: #7C3AED; font-weight: bold; text-transform: uppercase; font-size: 14px; margin-bottom: 15px; padding-bottom: 6px; border-bottom: 2px solid #7C3AED; display: block;">
                    ...
                    <td style="padding-bottom: 20px;">
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: bold; font-size: 12px; color: #7C3AED;">{{ $exp['period'] }}</td>
                            </tr>
                            <tr>
                    ...
                    <td style="padding-bottom: 15px;">
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: bold; font-size: 12px; color: #7C3AED;">{{ $edu['period'] }}</td>
                            </tr>
                            <tr>
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <div style="margin-bottom: 12px;">
                            <div style="font-weight: bold; font-size: 12px;">{{ $proj['name'] }}</div>
                             <div style="font-size: 11px; text-decoration: underline; color: #7C3AED;">{{ $proj['link'] }}</div>
