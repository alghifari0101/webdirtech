                ...
                <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
                    ...
                    @if (session()->has('ai_success'))
                        <div class="bg-violet-50 border-l-4 border-violet-500 p-4 mb-6 rounded-r-xl">
                            <p class="text-violet-800 text-sm flex items-center gap-2">
                                <i class="fa-solid fa-wand-magic-sparkles"></i> {{ session('ai_success') }}
                            </p>
                        </div>
                    @endif
                    ...
                    <div class="gap-6 mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-6">
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <!-- Basic -->
                                <button wire:click="$set('data.template', 'basic')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'basic' ? 'border-primary ring-2 ring-primary/20' : 'border-white hover:border-slate-300' }}">
                                ...
                                <!-- Modern -->
                                <button wire:click="$set('data.template', 'modern')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'modern' ? 'border-primary ring-2 ring-primary/20' : 'border-white hover:border-slate-300' }}">
                                    <div class="bg-white p-2 h-24 flex flex-col gap-1 shadow-sm">
                                ...
                                <!-- Elegant -->
                                <button wire:click="$set('data.template', 'elegant')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'elegant' ? 'border-primary ring-2 ring-primary/20' : 'border-white hover:border-slate-300' }}">
                                ...
                                <!-- Creative -->
                                <button wire:click="$set('data.template', 'creative')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'creative' ? 'border-emerald-600 ring-2 ring-emerald-600/20' : 'border-white hover:border-slate-300' }}">
                                ...
                                <!-- Premium ATS -->
                                <button wire:click="$set('data.template', 'premium_ats')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'premium_ats' ? 'border-[#2E004B] ring-2 ring-[#2E004B]/20' : 'border-white hover:border-slate-300' }}">
                                    <div class="bg-white h-24 shadow-sm flex flex-col">
                                ...
                                <!-- Modern Soft -->
                                <button wire:click="$set('data.template', 'modern_soft')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'modern_soft' ? 'border-[#7C3AED] ring-2 ring-[#7C3AED]/20' : 'border-white hover:border-slate-300' }}">
                                ...
                                <!-- Academic -->
                                <button wire:click="$set('data.template', 'professional_academic')" class="group relative p-1 rounded-xl border-2 transition-all overflow-hidden {{ $data['template'] === 'professional_academic' ? 'border-[#5B8C31] ring-2 ring-[#5B8C31]/20' : 'border-white hover:border-slate-300' }}">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <button wire:click="$set('data.language', 'id')" class="p-2 text-[10px] font-bold rounded-lg border transition-all {{ $data['language'] === 'id' ? 'bg-primary text-white border-primary' : 'bg-white text-slate-600 border-slate-200 hover:border-primary' }}">
                                    INDONESIA
                                </button>
                                <button wire:click="$set('data.language', 'en')" class="p-2 text-[10px] font-bold rounded-lg border transition-all {{ $data['language'] === 'en' ? 'bg-primary text-white border-primary' : 'bg-white text-slate-600 border-slate-200 hover:border-primary' }}">
                                    ENGLISH
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-100">
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                @error('photo') <span class="text-rose-500 text-[10px] block mt-1">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        @foreach($data['experience'] as $index => $exp)
                            <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4 relative group transition-all hover:border-primary/20">
                                <button wire:click="removeExperience({{ $index }})" class="absolute top-4 right-4 w-10 h-10 flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl md:opacity-0 md:group-hover:opacity-100 transition-all" title="Hapus">
                                    <i class="fa-solid fa-trash-can text-lg"></i>
                                </button>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Nama Perusahaan</label>
                                        <input type="text" wire:model.live="data.experience.{{ $index }}.company" placeholder="Contoh: PT. Maju Bersama" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Posisi / Jabatan</label>
                                        <input type="text" wire:model.live="data.experience.{{ $index }}.position" placeholder="Contoh: Senior Developer" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Periode</label>
                                        <input type="text" wire:model.live="data.experience.{{ $index }}.period" placeholder="Jan 2020 - Des 2022" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Lokasi</label>
                                        <input type="text" wire:model.live="data.experience.{{ $index }}.location" placeholder="Jakarta, Indonesia" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                </div>
                                <div class="w-full">
                                    <div class="flex justify-end mb-1">
                                        <button wire:click="polishExperience({{ $index }})" wire:loading.attr="disabled" wire:target="polishExperience({{ $index }})" class="text-[10px] font-bold text-primary hover:text-primary/80 transition-colors flex items-center gap-1 disabled:opacity-50">
                                            <span wire:loading.remove wire:target="polishExperience({{ $index }})">✨ Perbaiki dg AI</span>
                                            <span wire:loading wire:target="polishExperience({{ $index }})"><i class="fa-solid fa-spinner fa-spin"></i></span>
                                        </button>
                                    </div>
                                    <textarea wire:model.live="data.experience.{{ $index }}.description" rows="3" placeholder="Deskripsi pekerjaan & pencapaian..." class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none"></textarea>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="space-y-4 mt-10">
                        ...
                        @foreach($data['organizations'] as $index => $org)
                            <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4 relative group transition-all hover:border-primary/20">
                                <button wire:click="removeOrganization({{ $index }})" class="absolute top-4 right-4 w-10 h-10 flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl md:opacity-0 md:group-hover:opacity-100 transition-all" title="Hapus">
                                    <i class="fa-solid fa-trash-can text-lg"></i>
                                </button>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Nama Organisasi</label>
                                        <input type="text" wire:model.live="data.organizations.{{ $index }}.name" placeholder="Nama Organisasi" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Posisi</label>
                                        <input type="text" wire:model.live="data.organizations.{{ $index }}.position" placeholder="Contoh: Ketua" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Periode</label>
                                        <input type="text" wire:model.live="data.organizations.{{ $index }}.period" placeholder="2020 - 2021" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Lokasi</label>
                                        <input type="text" wire:model.live="data.organizations.{{ $index }}.location" placeholder="Jakarta" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                </div>
                                <textarea wire:model.live="data.organizations.{{ $index }}.description" rows="2" placeholder="Deskripsi peran..." class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none"></textarea>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="space-y-4 mt-10">
                        ...
                        @foreach($data['education'] as $index => $edu)
                            <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4 relative group transition-all hover:border-primary/20">
                                <button wire:click="removeEducation({{ $index }})" class="absolute top-4 right-4 w-10 h-10 flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl md:opacity-0 md:group-hover:opacity-100 transition-all" title="Hapus">
                                    <i class="fa-solid fa-trash-can text-lg"></i>
                                </button>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Nama Instansi</label>
                                        <input type="text" wire:model.live="data.education.{{ $index }}.school" placeholder="Nama Sekolah/Univ" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Gelar / Jurusan</label>
                                        <input type="text" wire:model.live="data.education.{{ $index }}.degree" placeholder="Contoh: S1 Informatika" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Periode</label>
                                        <input type="text" wire:model.live="data.education.{{ $index }}.period" placeholder="2016 - 2020" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tight">Lokasi</label>
                                        <input type="text" wire:model.live="data.education.{{ $index }}.location" placeholder="Jakarta" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-primary/50 transition-all">
                                    </div>
                                </div>
                                <textarea wire:model.live="data.education.{{ $index }}.description" rows="2" placeholder="Detail pendidikan/IPK dsb..." class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none"></textarea>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="space-y-4 mt-10">
                        ...
                        @foreach($data['projects'] as $index => $project)
                            <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4 relative group transition-all hover:border-primary/20">
                                <button wire:click="removeProject({{ $index }})" class="absolute top-4 right-4 w-10 h-10 flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl md:opacity-0 md:group-hover:opacity-100 transition-all" title="Hapus">
                                    <i class="fa-solid fa-trash-can text-lg"></i>
                                </button>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <input type="text" wire:model.live="data.projects.{{ $index }}.name" placeholder="Nama Proyek" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none">
                                    <input type="text" wire:model.live="data.projects.{{ $index }}.period" placeholder="Periode" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none">
                                </div>
                                <input type="text" wire:model.live="data.projects.{{ $index }}.link" placeholder="Link / URL Proyek" class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none">
                                <textarea wire:model.live="data.projects.{{ $index }}.description" rows="3" placeholder="Jelaskan peran Anda & hasil..." class="w-full px-4 py-2 border border-slate-200 rounded-lg text-sm outline-none"></textarea>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @foreach($data['skills'] as $index => $skill)
                                <div class="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm group">
                                    <input type="text" wire:model.live="data.skills.{{ $index }}" placeholder="Keahlian" class="bg-transparent border-none outline-none text-sm w-32 focus:ring-0 p-0">
                                    <button wire:click="removeSkill({{ $index }})" class="text-slate-300 hover:text-rose-500 transition-colors">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($data['languages'] as $index => $lang)
                                <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex gap-3 relative group transition-all hover:border-primary/20">
                                    <button wire:click="removeLanguage({{ $index }})" class="absolute -top-2 -right-2 w-7 h-7 bg-rose-500 text-white rounded-lg flex items-center justify-center md:opacity-0 md:group-hover:opacity-100 transition-all shadow-lg">
                                        <i class="fa-solid fa-xmark"></i>
                                    </button>
                                    <input type="text" wire:model.live="data.languages.{{ $index }}.name" placeholder="Bahasa" class="flex-1 px-3 py-2 border border-slate-200 rounded-lg text-sm outline-none">
                                    <input type="text" wire:model.live="data.languages.{{ $index }}.level" placeholder="Level" class="w-24 px-3 py-2 border border-slate-200 rounded-lg text-sm outline-none">
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="mt-12 flex flex-col items-center gap-4 border-t border-slate-100 pt-8">
                        ...
                        <a href="{{ route('member.dashboard') }}" class="text-slate-400 hover:text-slate-600 font-bold transition-all text-xs uppercase tracking-widest py-2">
                ...
                <div @click.away="showUpgradeModal = false" class="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-sm w-full transform transition-all">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-slate-500 text-sm leading-relaxed mb-8">
                            Template <span class="text-slate-900 font-bold uppercase">{{ $data['template'] }}</span> adalah fitur premium. Aktifkan sekarang hanya dengan <strong>Rp 19.000</strong> untuk langganan 1 bulan!
                        </p>
                        <div class="space-y-3">
