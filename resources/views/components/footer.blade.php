        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li><a href="{{ route('service.migration') }}" class="hover:text-white transition-colors">Migrasi Website</a></li>
                    <li><a href="{{ route('service.gmb') }}" class="hover:text-white transition-colors">Pembuatan Google Bisnis</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li><a href="{{ route('ask') }}" class="hover:text-white transition-colors">FAQ / Ask</a></li>
