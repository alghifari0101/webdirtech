    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li><a href="<?php echo e(route('service.vps')); ?>" class="hover:text-white transition-colors">Jasa Install VPS</a></li>
                    <li><a href="<?php echo e(route('service.website')); ?>" class="hover:text-white transition-colors">Jasa Pembuatan Website</a></li>
                    <li><a href="<?php echo e(route('service.cv')); ?>" class="hover:text-white transition-colors">Jasa Bikin CV ATS</a></li>
                    <li><a href="<?php echo e(route('service.migration')); ?>" class="hover:text-white transition-colors">Jasa Migrasi Website</a></li>
                    <li><a href="<?php echo e(route('service.gmb')); ?>" class="hover:text-white transition-colors">Jasa Pembuatan Google Bisnis</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-6 text-sm">
                    ...
                    <li class="flex gap-4">
                        ...
                        <a href="https://wa.me/<?php echo e(config('contact.whatsapp')); ?>" class="hover:text-white transition-colors font-bold text-white">+<?php echo e(config('contact.whatsapp', '6281541108598')); ?></a>
                    </li>
                    <li class="flex gap-4">
        ...
        <div class="pt-8 border-t border-white/5 flex flex-wrap justify-between items-center gap-4 text-xs">
            ...
            <div class="flex gap-6">
                <a href="<?php echo e(route('sitemap')); ?>" class="hover:text-white transition-colors">Sitemap</a>
