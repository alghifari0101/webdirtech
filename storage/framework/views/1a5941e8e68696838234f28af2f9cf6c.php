        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 mb-16">
                <button wire:click="$set('category', null)" 
                    class="px-6 py-3 rounded-xl font-bold text-sm transition-all <?php echo e(is_null($category) ? 'bg-slate-900 text-white shadow-xl shadow-slate-900/20' : 'bg-slate-50 text-slate-500 hover:bg-slate-100'); ?>">
                    Semua Topik
                </button>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button wire:click="$set('category', '<?php echo e($cat->slug); ?>')" 
                        class="px-6 py-3 rounded-xl font-bold text-sm transition-all <?php echo e($category === $cat->slug ? 'bg-blue-600 text-white shadow-xl shadow-blue-500/20' : 'bg-slate-50 text-slate-500 hover:bg-slate-100'); ?>">
                        <?php echo e($cat->name); ?>
