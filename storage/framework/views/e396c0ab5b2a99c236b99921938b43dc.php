        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div class="text-center" style="max-width: 800px; margin: 0 auto; color: white;">
                ...
                <div style="display: flex; align-items: center; justify-content: center; gap: 15px; font-size: 1.1rem; opacity: 0.9;">
                    <a href="<?php echo e(route('ask')); ?>" style="color: white; text-decoration: none; border-bottom: 1px solid rgba(255,255,255,0.3);">Pusat Bantuan</a>
            ...
            <div style="max-width: 900px; margin: 0 auto;">
                <div class="ask-card" style="background: white; border-radius: 40px; box-shadow: 0 40px 100px -20px rgba(0,0,0,0.05); overflow: hidden; border: 1px solid #f1f5f9;">
                    <div style="padding: 60px;">
                        <div style="display: flex; gap: 40px; align-items: flex-start; margin-bottom: 60px;">
                            ...
                            <div>
                                ...
                                <p style="margin-top: 15px; color: #94a3b8; font-weight: 500;">Diterbitkan <?php echo e($ask->created_at->format('d M Y')); ?></p>
                            </div>
                        </div>
                        ...
                        <div style="padding: 0 0 0 110px;" class="answer-wrapper">
                            ...
                            <div style="margin-top: 50px; display: flex; align-items: center; gap: 20px; padding: 25px; background: #f8fafc; border-radius: 24px;">
                                ...
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.85rem; color: #94a3b8;">Terakhir diperbarui <?php echo e($ask->updated_at->diffForHumans()); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="padding: 30px 60px; background: #1e293b; display: flex; justify-content: space-between; align-items: center;">
                        <a href="<?php echo e(route('ask')); ?>" style="color: rgba(255,255,255,0.7); text-decoration: none; font-weight: 600; display: flex; align-items: center; gap: 10px; transition: color 0.2s ease;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,0.7)'">
...
<?php /**PATH C:\laravel\dirtech\resources\views/livewire/ask-detail.blade.php ENDPATH**/ ?>