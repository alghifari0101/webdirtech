...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-rose-500 text-[10px] font-bold mt-1 uppercase tracking-tight"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-8 pt-8 border-t border-slate-100 text-center">
                        <p class="text-slate-500 text-sm">
                            Sudah punya akun? 
                            <a href="<?php echo e(route('login')); ?>" class="text-primary font-bold hover:underline">Login disini</a>
                        </p>
                    </div>
                </div>
...
<?php /**PATH C:\laravel\dirtech\resources\views/livewire/auth/register.blade.php ENDPATH**/ ?>