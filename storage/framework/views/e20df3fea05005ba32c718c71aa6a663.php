                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div>
                                    <div class="font-bold text-slate-900 leading-tight"><?php echo e($post->title); ?></div>
                                    <div class="text-[10px] text-slate-400 font-medium">/blog/<?php echo e($post->slug); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end gap-2">
                                <button wire:click="edit(<?php echo e($post->id); ?>)" class="p-2 text-slate-400 hover:text-blue-600 transition-colors">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button>
                                <button onclick="confirm('Hapus artikel ini?') || event.stopImmediatePropagation()" wire:click="delete(<?php echo e($post->id); ?>)" class="p-2 text-slate-400 hover:text-rose-600 transition-colors">
