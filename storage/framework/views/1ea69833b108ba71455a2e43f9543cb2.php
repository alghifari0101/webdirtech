<div>
            ...
            <div class="hero-grid">
                ...
                <div class="hero-content">
                    ...
                    <div class="hero-actions">
                        <a href="https://wa.me/<?php echo e(config('contact.whatsapp')); ?>" class="btn-premium">
    ...
    <section id="services" class="features-section">
        <div class="container mx-auto">
            <div class="features-grid" style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));">
                <!-- Service 1 -->
                <a href="<?php echo e(route('service.vps')); ?>" class="feature-card block group hover:no-underline">
                ...
                <!-- Service 2 -->
                <a href="<?php echo e(route('service.website')); ?>" class="feature-card block group hover:no-underline">
                    <div class="feature-icon group-hover:scale-110 transition-transform">
                ...
                <!-- Service 3 -->
                <a href="<?php echo e(route('service.migration')); ?>" class="feature-card block group hover:no-underline">
                    <div class="feature-icon group-hover:scale-110 transition-transform">
                 ...
                 <!-- Service 4 -->
                <a href="<?php echo e(route('service.gmb')); ?>" class="feature-card block group hover:no-underline">
                    <div class="feature-icon group-hover:scale-110 transition-transform">
        ...
        <div class="container mx-auto">
            <div class="about-grid">
                ...
                <div class="about-content">
                    ...
                    <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center gap-2 text-primary font-bold hover:gap-3 transition-all mt-4">
    ...
    <section class="cta-section">
        <div class="container mx-auto">
            ...
            <a href="https://wa.me/<?php echo e(config('contact.whatsapp')); ?>" class="btn btn-white">Hubungi Kami via WhatsApp</a>
        </div>
    </section>
</div>
<?php /**PATH C:\laravel\dirtech\resources\views/livewire/landing-page.blade.php ENDPATH**/ ?>