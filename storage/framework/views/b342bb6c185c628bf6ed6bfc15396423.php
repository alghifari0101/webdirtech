<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Stat Card 4 -->
        <a href="<?php echo e(route('admin.payments')); ?>" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-5 hover:border-amber-400 transition-colors group">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-slate-800"><?php echo e(\App\Models\Payment::where('status', 'pending')->count()); ?></h3>
            </div>
        </a>
    </div>
