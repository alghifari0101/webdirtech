    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-5">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-slate-800"><?php echo e($stats['total_asks']); ?></h3>
            </div>
        </div>
    ...
    <div class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-100 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.asks')); ?>" class="text-primary text-sm font-semibold hover:underline">Lihat Semua</a>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_asks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-slate-50 transition-colors border-l-4 border-primary">
                            <div class="flex-1">
                                <h4 class="font-bold text-slate-800 line-clamp-1"><?php echo e($ask->question); ?></h4>
                                <p class="text-sm text-slate-500 mt-1 line-clamp-2"><?php echo e($ask->answer); ?></p>
                            </div>
                            <span class="text-xs text-slate-400 whitespace-nowrap"><?php echo e($ask->created_at->diffForHumans()); ?></span>
                        </div>
