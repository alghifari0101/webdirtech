        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="p-10 rounded-[3rem] bg-slate-50 border border-slate-100 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 group">
                    ...
                    <a href="https://wa.me/<?php echo e(config('contact.whatsapp')); ?>" class="inline-flex items-center gap-2 py-3 font-bold text-accent group-hover:gap-4 transition-all">
...
<?php /**PATH C:\laravel\dirtech\resources\views/livewire/contact-us.blade.php ENDPATH**/ ?>